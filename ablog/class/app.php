...
class App {
	...
	*/
	...
	public function GetManageUrl(){
		global $zbp;
		return $zbp->host . 'feifeis/' . $this->type . '/' . $this->id . '/' . $this->path;
	}
	/**
	 * 获取应用目录地址
	 * @access	public
	...
	public function GetDir(){
		global $zbp;
		return $zbp->path . 'feifeis/' . $this->type . '/' . $this->id . '/';
	}
	/**
	 * 获取应用Logo图片地址
	 * @access	public
	...
	public function GetLogo(){
		global $zbp;
		if($this->type=='plugin'){
			return $zbp->host . 'feifeis/' . $this->type . '/' . $this->id . '/logo.png';
		}else{
			return $zbp->host . 'feifeis/' . $this->type . '/' . $this->id . '/screenshot.png';
		}
	}
	/**
	 * 获取应用截图地址

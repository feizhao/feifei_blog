...
window.onload = function () {
    ...
    emotion.SmileyPath = editor.options.emotionLocalization === true ? 'images/' : "<?php echo $bloghost; ?>feifeis/emotion/";
<?php
...
function over( td, srcPath, posFlag ) {
	...
	$G( 'faceReview' ).src = "<?php echo $bloghost;?>system/image/admin/none.gif";

...
function ueditor_SyntaxHighlighter_print(){
	...
	echo "\r\n".'document.writeln("<script src=\'' . $zbp->host .'feifeis/plugin/UEditor/third-party/SyntaxHighlighter/shCore.pack.js\' type=\'text/javascript\'></script><link rel=\'stylesheet\' type=\'text/css\' href=\'' . $zbp->host .'feifeis/plugin/UEditor/third-party/SyntaxHighlighter/shCoreDefault.pack.css\'/>");'."\r\n";
...
{
	global $zbp;
	echo '<script type="text/javascript" src="' . $zbp->host . 'feifei/plugin/UEditor/ueditor.config.php"></script>';
	echo '<script type="text/javascript" src="' . $zbp->host . 'feifei/plugin/UEditor/ueditor.all.min.js"></script>';

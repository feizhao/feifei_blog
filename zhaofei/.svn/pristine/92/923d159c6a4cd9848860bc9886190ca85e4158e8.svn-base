...
function widget_sort($title){
	...
	<a href="<?php echo BLOG_URL; ?>rss.php?sort=<?php echo $value['sid']; ?>"><img src="<?php echo TEMPLATE_URL; ?>img/rss.png" alt="订阅该分类"/></a>
	</li>
	<?php endforeach; ?>
	</ul>
	</div>
...
function widget_twitter($title){
	...
	<li><?php echo $value['t']; ?>&nbsp;<?php echo smartDate($value['date']); ?></li>
	<?php endforeach; ?>
    <?php if ($istwitter == 'y') :?>
...
function widget_search($title){ ?>
	...
	<input name="keyword" style="background-color:#EEE;" type="text" value="" style="width:120px;"/>
...
function topflg($istop){
	$topflg = $istop == 'y' ? "<img src=\"".TEMPLATE_URL."/img/import.gif\" title=\"置顶日志\" /> " : '';
	echo $topflg;
}
?>
<?php
...
function neighbor_log($neighborLog){
	extract($neighborLog);?>
	<?php if($prevLog):?>
	上一篇: <a href="<?php echo Url::log($prevLog['gid']) ?>"><?php echo $prevLog['title'];?></a><br/>
	<?php endif;?>
	<?php if($nextLog):?>

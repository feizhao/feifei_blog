...
<head lang="en">
  <meta charset="UTF-8">
  <title><?php echo $core->name.' | '.$core->subname; ?></title>
  ...
  <link rel="alternate icon" type="image/png" href="<?php echo $core->assets; ?>i/favicon.png">
  ...
  <div class="am-u-md-9">
    <article class="blog-main">
      ...
      <div class="am-g blog-content">
        ...
        <div class="am-u-lg-5">
          <p><img height="80" src="http://f.cl.ly/items/451O3X0g47320D203D1B/不夠活潑.jpg"></p>
        </div>
      </div>
      <div class="am-g">
...
<footer class="blog-footer">
  <p><?php echo $core->name; ?><br/>
    <small>© <?php echo $core->config['BLOG_COPYRIGHT']; ?>.</small>
  </p>
</footer>
